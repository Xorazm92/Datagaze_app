...
export async function seed(knex: Knex): Promise<void> {
  ...
  // Insert admin users
  const adminUsers = await knex('admin').insert([
    {
  ...
  // Insert SSH servers
  const sshServers = await knex('ssh_servers').insert([
    {
  ...
  // Insert computers
  const computers = await knex('computers').insert([
    {
  ...
  // Insert licenses
  const licenses = await knex('licenses').insert([
    {
