...
import { InstallApplicationDto, UpdateApplicationDto, RemoveApplicationDto } from './dto/computer.dto';
...
export class ComputersController {
  ...
  @ApiResponse({ 
    ...
    schema: {
      ...
      properties: {
        ...
        message: { type: 'string', example: 'Unauthorized. Please provide a valid token.' }
      }
    }
  })
  @ApiResponse({ 
  ...
  @ApiResponse({ 
    ...
    schema: {
      ...
      properties: {
        status: { type: 'string', example: 'success' },
        message: { type: 'string', example: 'Installation initiated successfully.' },
  ...
  @ApiResponse({ 
    ...
    schema: {
      ...
      properties: {
        status: { type: 'string', example: 'error' },
        message: { type: 'string', example: 'The selected computer is offline. Installation cannot proceed.' }
      }
    }
  })
  @ApiResponse({ 
  ...
  @ApiResponse({ 
    ...
    schema: {
      ...
      properties: {
        status: { type: 'string', example: 'success' },
        message: { type: 'string', example: 'Update process started successfully.' },
  ...
  @ApiResponse({ 
    ...
    schema: {
      ...
      properties: {
        status: { type: 'string', example: 'error' },
        message: { type: 'string', example: 'Application not found on the target computer.' }
      }
    }
  })
  @ApiResponse({ 
    ...
    schema: {
      ...
      properties: {
        status: { type: 'string', example: 'error' },
        message: { type: 'string', example: 'Failed to download update from the provided URL.' }
      }
    }
  })
  ...
  @ApiResponse({ 
    ...
    schema: {
      ...
      properties: {
        status: { type: 'string', example: 'success' },
        message: { type: 'string', example: 'Application removal started successfully.' },
  ...
  @ApiResponse({ 
    ...
    schema: {
      ...
      properties: {
        status: { type: 'string', example: 'error' },
        message: { type: 'string', example: 'The specified application was not found on the computer.' }
      }
    }
  })
  @ApiResponse({ 
    ...
    schema: {
      ...
      properties: {
        status: { type: 'string', example: 'error' },
        message: { type: 'string', example: 'Failed to remove the application due to a system error.' }
      }
    }
  })
